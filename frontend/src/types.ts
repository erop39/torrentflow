...
export type Rule = {
  ...
  double_upload_only: boolean;
  max_size_bytes: number | null;
  uploader_whitelist: string;
  uploader_blacklist: string;
  qb_category: string;
  save_path: string;
  enabled: boolean;
};
...
export type DiskThreshold = { disk_free_threshold_percent: number };
