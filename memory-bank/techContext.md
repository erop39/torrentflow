...
Verification: run backend pytest with plugin autoload disabled; run the Vite production build. Alembic revisions currently run through `20260825_06`. Git remote `origin` tracks `https://github.com/erop39/torrentflow.git` on `main`.
